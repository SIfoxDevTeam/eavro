...
%% TESTS
%%=========================================================================================
'ISSUE_11_2nd_part_test'() ->
    Union = [string, null],
    EncIoList = eavro_codec:encode(Union, null),
    ?assertMatch(
       {null, <<>> = _Rest},
       eavro_codec:decode(Union, EncIoList)),
    EncIoList1 = eavro_codec:encode(Union, {string, <<"Ho-ho-ho!">>}),
    ?assertMatch(
       { {string, <<"Ho-ho-ho!">>}, <<>> = _Rest},
       eavro_codec:decode(Union, EncIoList1)).
